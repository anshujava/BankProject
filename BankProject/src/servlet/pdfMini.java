 ...
 * @version
 */
public class pdfMini extends HttpServlet {
    ...
    throws ServletException, IOException {
      ...
      try{ 
        ...
        document.open();
        document.add(new Paragraph("                                                    Mini Statement", new Font(Font.TIMES_NEW_ROMAN, 14, Font.BOLD))); 
